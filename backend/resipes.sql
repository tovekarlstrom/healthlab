...
INSERT INTO recipes (name, rating, time, likes, comments, protein, carbs, fat, kcal, ingredients, instructions)
VALUES('Hawaiian Raw Poke Bowl', 4, 45, 178, 9, 31, 43, 30, 572, ARRAY['140 g Salma lax, rå vikt', '40 g ris, okokt vikt', '50 g sjögrässallad, färdigköpt', '60 g avokado','20 g rädisor', '20 g gurka', '10 g sojasås', 'vårlök', 'sesamfrön'], ARRAY['Skär laxen i tuggstora bitar och marinera bitarna med sojasås i cirka 30 minuter.', 'Koka riset enligt anvisningar på förpackningen.', 'Skiva rädisor och gurka.', 'Dela, kärna ur och skär avokadon i bitar.', 'Komponera ihop skålen med sjögräs.', 'Toppa rätten med klippt vårlök och sesamfrön.']);

INSERT INTO recipes (name, rating, time, likes, comments, protein, carbs, fat, kcal, ingredients, instructions)
VALUES('Kycklingsallad', 5, 35, 254, 6, 35, 30, 25, 450,
ARRAY[
  '300 g kycklingfilé',
  '200 g kokta linser',
  '1 rödlök',
...
ARRAY[
  ...
  INSERT INTO recipes (name, rating, time, likes, comments, protein, carbs, fat, kcal, ingredients, instructions)
VALUES('Protein Smoothie', 5, 10, 211, 3, 30, 30, 15, 334,
ARRAY[
  '1 mogen banan',
